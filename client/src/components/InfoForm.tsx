    ...
    return (
        <section className="info-form">
            <header className="flex flex-col gap-1 md:gap-3">
                <h1 className="text-24 lg:text-36 font-semibold text-gray-900">Personal Information</h1>
            </header>


          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                <CustomInput control={form.control} name='given_name' label="First Name" placeholder='Enter your first name' />
                <CustomInput control={form.control} name='family_name' label="Last Name" placeholder='Enter your first name' />
